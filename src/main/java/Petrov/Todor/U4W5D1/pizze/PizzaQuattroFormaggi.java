...
public class PizzaQuattroFormaggi extends Pizza {
    ...
    public PizzaQuattroFormaggi(String nome, DimensionePizza dimensionePizza, double prezzo, BasePizza base, List<String> ingredienti, List<Toppings> toppings, TipoImpasto tipoImpasto, boolean vegetariana) {
