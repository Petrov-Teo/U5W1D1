...
public class PizzaCapricciosa extends Pizza {
    ...
    public PizzaCapricciosa(String nome, DimensionePizza dimensionePizza, double prezzo, BasePizza base, List<String> ingredienti, List<Toppings> toppings, TipoImpasto tipoImpasto, boolean vegetariana) {
