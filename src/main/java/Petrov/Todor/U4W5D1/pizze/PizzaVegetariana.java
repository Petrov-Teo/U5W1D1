...
public class PizzaVegetariana extends Pizza {
    public PizzaVegetariana(String nome, DimensionePizza dimensionePizza, double prezzo, BasePizza base, List<String> ingredienti, List<Toppings> toppings, TipoImpasto tipoImpasto, boolean vegetariana) {
